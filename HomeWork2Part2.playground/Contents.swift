...
func getCelsius(_ kelvin: Double) -> String{
    let value =  kelvin - 273.15
    return String(format: "%.1f", value)
}

func getFahrenheit(_ kelvin: Double) -> String {
    let value = kelvin * (9.0/5.0) - 459.67
    return String(format: "%.1f", value)
}
...
for index in cityNames.indices {
...
for weatherInfo in weatherInCities{
    ...
    print("\n\(city):")
    print("t: \(getCelsius(kelvin)) C")
    print("t: \(getFahrenheit(kelvin)) F")
    print("t: \(kelvin) K")
    print("min t: \(getCelsius(kelvinMin)) C / \(getFahrenheit(kelvinMin)) F")
    print("max t: \(getCelsius(kelvinMax)) C / \(getFahrenheit(kelvinMax)) F")
}
print("\n-----------------------------")
print("\n\n")
...
print("---------- ЕКРАН 2 ----------")
for index in weatherInCities.indices {
    let weatherInfo = weatherInCities[index]
    let city = weatherInfo.city
    let celsius = getCelsius(weatherInfo.temp)
    print("\n\(city):\nt: \(celsius) C")
}
print("\n-----------------------------")
print("\n\n")
...
for index in 0 ..< weatherInCities.count {
    let weatherInfo = weatherInCities[index]
    let city = weatherInfo.city
    let fahrenheit = getFahrenheit(weatherInfo.temp)
    print("\n\(city):\nt: \(fahrenheit) F")
}
print("\n-----------------------------")
